...
function TModelConexaoFireDac.Commit: IModelConexao;
begin
  Result := Self;
  FConnList.Items[FIndexConn].Commit;
end;
...
function TModelConexaoFireDac.Rollback: IModelConexao;
begin
  Result := Self;
  FConnList.Items[FIndexConn].Rollback;
end;

function TModelConexaoFireDac.StartTransaction: IModelConexao;
begin
  Result := Self;
  FConnList.Items[FIndexConn].StartTransaction;
end;
